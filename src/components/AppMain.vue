            ...
            <div class="my-row-between">
               ...
               <div id="yt-container" class="col-8 pe-4">
                  <iframe
                     class="w-100"
                     height="545"
                     src="https://www.youtube.com/embed/BP0k4SdquG0"
         ...
         <div id="bg-layover" class="w-100 h-100">
            <div id="coming-info" class="text-center">
               ...
               <div id="actors" class="py-3">
                  <h3 class="mb-4">
                     JON PLAYER <span class="color-green">&amp; </span>EMILY
                     ROSE
                  </h3>
      ...
      <section id="movie-cards">
         <div class="my-container">
            ...
            <nav class="w-50">
               <ul>
                  <li
                     v-for="(item, index) in store.mediaCategories"
                     :key="index"
                     class="movie-category"
                     :class="item.name == categorySelected ? 'active' : ''"
                     @click="categorySelected = item.name"
                  >
                     {{ item.name }}
                  </li>
               </ul>
